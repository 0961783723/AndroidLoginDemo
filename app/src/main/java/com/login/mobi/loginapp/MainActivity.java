...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkAccount(){
        final DatabaseHelper dbHelper = new DatabaseHelper(this);
        User user = dbHelper.queryUser(edtEmail.getText().toString(), edtPassword.getText().toString());
        String namex = edtEmail.getText().toString();
        String passwordx = edtPassword.getText().toString();
        Boolean check = dbHelper.checkAccount(namex,passwordx);
        if (CheckPass.checknow(edtPassword.getText().toString())&&check==true){
